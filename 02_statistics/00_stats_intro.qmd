...
#### Common Pitfalls in Statistical Analysis {#pitfalls}
...
#### Official Statistics {#official_stats}
<!-- TO DO: consider whether to move this course somewhere else (ML section) -->
...
- [Microsimulation & Machine Learning with Official Statistics Data - GitHub Repository](https://github.com/BERD-NFDI/microsimulation-machine-learning-os/tree/main)
- [Microsimulation & Machine Learning with Official Statistics Data - BERD Academy Information & Registration Page](https://www.berd-nfdi.de/berd-academy/microsimulation-machine-learning-with-official-statistics-data/)
